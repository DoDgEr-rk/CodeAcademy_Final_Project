...
commit;
/
-- 14:30 min. / dolnata e 12:30 !! da q prepravq v julian
...
/
select * from invoices
where inv_no = '10_19_20230201';
/
update invoices set amount_due = 15 where inv_no = '6_1_20221201';
update invoices set amount_due = 15 where inv_no = '10_19_20230201';
/
...
SELECT ov.payment_id, ov.amount, i.inv_no, i.amount, i.amount_due
			  ...
			  WHERE p.payment_id = ov.original_payment_id and 
                             ...
                             and i.customer_id = 6;
/
select MAX(TO_NUMBER(INVOICE_NO)) from payments;
worder by payment_id desc;